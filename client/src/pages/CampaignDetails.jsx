...
const CampaignDetails = () => {
  ...
  const showFundingSection = campaignStats?.isActive && 
                            ...
                            !isOwner; // Only show funding if not the owner
    ...
    <div>
      ...
      <div className="mt-[60px] flex lg:flex-row flex-col gap-5">
        <div className="flex-[2] flex flex-col gap-[40px]">
          ...
          <div>
            <h4 className="font-epilogue font-semibold text-[18px] text-white uppercase">Campaign Details</h4>
            <div className="mt-[20px] flex flex-col gap-4">
              <div className="flex justify-between">
                <p className="font-epilogue text-[16px] text-[#808191]">Category</p>
                <p className="font-epilogue text-[16px] text-white">{state.category}</p>
              </div>
              <div className="flex justify-between">
                <p className="font-epilogue text-[16px] text-[#808191]">Minimum Contribution</p>
                <p className="font-epilogue text-[16px] text-white">{state.minimumContribution} ETH</p>
              </div>
              {campaignStats && (
                <>
                  <div className="flex justify-between">
                    <p className="font-epilogue text-[16px] text-[#808191]">Average Donation</p>
                    <p className="font-epilogue text-[16px] text-white">{campaignStats.averageDonation} ETH</p>
                  </div>
                  <div className="flex justify-between">
                    <p className="font-epilogue text-[16px] text-[#808191]">Status</p>
        ...
        {showFundingSection ? (
          ...
          <div className="flex-1">
            <h4 className="font-epilogue font-semibold text-[18px] text-white uppercase">Campaign Management</h4>   
            <div className="mt-[20px] flex flex-col p-4 bg-[#1c1c24] rounded-[10px]">
              <CustomButton 
                btnType="button"
                title="Close Campaign"
                styles="w-full bg-[#ff3333]"
